...
<header id="banner" class="carousel slide zoom carousel-fade" data-ride="carousel">
    ...
    <div class="carousel-inner"><!-- Inner wrapper for slides -->
        <div class="item active"> <!-- First item slider -->
            <img src="img/banners/IMG_4779.jpg" alt="banner-img"> <!-- First item background image slider -->
        ...
        <div class="item"> <!-- Second item slider -->
            <img src="img/banners/IMG_4578.jpg" alt="banner-img"> <!-- Second item background image slider -->
        ...
        <div class="item"> <!-- Third item slider -->
            <img src="img/banners/IMG_4529.jpg" alt="banner-img"> <!-- Third item background image slider -->
            <div class="carousel-caption">
                <div class="content">
                    <div class="text wow">
                      <h1>Angela Todd Photography</h1>
        ...
        <div class="item"> <!-- Fourth item slider -->
            <img src="img/banners/IMG_4923.jpg" alt="banner-img"> <!-- Fourth item background image slider -->
            <div class="carousel-caption">
                <div class="content">
                    <div class="text wow">
                      <h1>Angela Todd Photography</h1>
        ...
        <div class="item"> <!-- Fifth item slider -->
            <img src="img/banners/IMG_4663.jpg" alt="banner-img"> <!-- Fifth item background image slider -->
            <div class="carousel-caption">
                <div class="content">
                    <div class="text wow">
                      <h1>Angela Todd Photography</h1>
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                    <div class="modal-body">
                        ...
                        <p>Use this area to describe your project. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Est blanditiis dolorem culpa incidunt minus dignissimos deserunt repellat aperiam quasi sunt officia expedita beatae cupiditate, maiores repudiandae, nostrum, reiciendis facere nemo!</p>
                        <p>
                            <strong>Want these theme for your portfolio?</strong> You can download 60 of them for free, courtesy of jlpmedia.com, or you can purchase the 1500 icon set <a href="#">here</a>.</p>
                        <ul class="list-inline">
                            <li>Date: August 2014</li>
                            <li>Client: Tarsier Graphics</li>
                            <li>Category: Graphic Design</li>
...
<section id="footer"> <!-- Start footer -->
    <div class="container"> <!-- Container -->
        ...
        <br>
        <!-- Buttons -->
        <a id="show" class="btn wow" data-wow-delay="0.6s"><h2>WORK w/ ME</h2></a> <!-- Button to click toggle contact form -->
        <br>
